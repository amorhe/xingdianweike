...
instance.interceptors.request.use(
  config => {
    ...
    const TOKEN = "Bearer eyJhbGciOiJIUzUxMiJ9.eyJvcGVuaWQiOiJ3ZWRyd3F3cWVld3EiLCJleHAiOjE1ODEwMTQwMzJ9.Cz2lber7oFFo8hnOgHD14ESGNdnXpwOYViHMXF1uWCh95leYbUkPSfrcL4gTgIyVdfes-r9udFNj3HPD0lFHDw"
    if(TOKEN){
      // 配置请求头 token
